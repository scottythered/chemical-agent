import csv
from mutagen.id3 import ID3, TIT2, TALB, TPE1, TCOP, TYER, TCON # calls the necessary mutagen library ID3 tags
...
for songFile, songTitle, album, artist, year, genre, rights in reader: # the columns in your csv
